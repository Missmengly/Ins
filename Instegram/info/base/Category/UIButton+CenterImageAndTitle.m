...
- (void)verticalCenterImageAndTitle:(CGFloat)spacing
{
    ...
    self.imageEdgeInsets = UIEdgeInsetsMake(- (titleSize.height + spacing/2), WidthScale(10), 0.0, - titleSize.width+WidthScale(11));
}

- (void)custom:(CGFloat)spa
{
...
//    [self verticalCenterImageAndTitle:DEFAULT_SPACING];
    ...
    // lower the text and push it left to center it
    self.titleEdgeInsets = UIEdgeInsetsMake(0.0, - imageSize.width , - (imageSize.height + spa/2), + WidthScale(8));
    ...
    // raise the image and push it right to center it
    self.imageEdgeInsets = UIEdgeInsetsMake(- (titleSize.height + spa/2), WidthScale(13), 0.0, - titleSize.width+WidthScale(14));
}

- (void)customlu:(CGFloat)lu
{
    CGSize imageSize = self.imageView.frame.size;
    CGSize titleSize = self.titleLabel.frame.size;
    
    // lower the text and push it left to center it
    self.titleEdgeInsets = UIEdgeInsetsMake(0.0, - imageSize.width, - (imageSize.height + lu/2), 0.0);
    ...
    // raise the image and push it right to center it
    self.imageEdgeInsets = UIEdgeInsetsMake(- (titleSize.height + lu/2), WidthScale(9), 0.0, - titleSize.width+WidthScale(15));
}
- (void)horizontalCenterTitleAndImage:(CGFloat)spacing
{
    ...
    // raise the image and push it right to center it
    self.imageEdgeInsets = UIEdgeInsetsMake(0.0, titleSize.width + spacing/2, 0.0, - titleSize.width-WidthScale(50));
}
