...
- (CGFloat)setupPicUrlArray:(NSArray *)picUrlArray{
    ...
    for (int i = 0; i< _picUrlArray.count; i++) {
        ...
        if (i==0) {
            imageView.image = kImageWithName(@"257269881137004646");

        }else if (i==1){
            imageView.image = kImageWithName(@"201313578313973764");

        }else if (i==2){
            imageView.image = kImageWithName(@"415867260901130467");

        }else{
            imageView.image = kImageWithName(@"416429231602008632");
