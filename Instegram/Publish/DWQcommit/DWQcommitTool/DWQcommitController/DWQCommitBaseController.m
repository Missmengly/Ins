...
-(void)initPickerView{
    ...
    self.pickerCollectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(10, 180, bdtScreenWidth - 20, 120) collectionViewLayout:layout];//self.view.frame
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == _imageArray.count) {
        ...
        cell.profilePhoto.contentMode = UIViewContentModeScaleAspectFit;
...
- (void)deletePhoto:(UIButton *)sender{
    ...
    NSLog(@"%s, line = %d \n %ld", __FUNCTION__, __LINE__,sender.tag);
...
- (void)changeCollectionViewHeight{
    ...
    if (_collectionFrameY) {
        _pickerCollectionView.frame = CGRectMake(10, _collectionFrameY + 180, [UIScreen mainScreen].bounds.size.width - 20, (((float)[UIScreen mainScreen].bounds.size.width-64.0) /4.0 +20.0)* ((int)(_arrSelected.count)/4 +1)+20.0);
    } else{
        _pickerCollectionView.frame = CGRectMake(10, 180, [UIScreen mainScreen].bounds.size.width-20, (((float)[UIScreen mainScreen].bounds.size.width-64.0) /4.0 +20.0)* ((int)(_arrSelected.count)/4 +1)+20.0);
    }
...
//        [self updateImageWithData:image];
//    }
}
