...
- (NSAttributedString *)attributedText
{
    ...
    if ([self.commentId isEqualToString:MHAllCommentsId]) {
        ...
        mutableAttributedString.yy_font = kFontSystem(13);// MHCommentTextFont;
        mutableAttributedString.yy_color = [UIColor blueColor];//kColor4A;//MHGlobalOrangeTextColor;
    ...
    if (!MHObjectIsNil(self.toUser) && self.toUser.nickname.length>0) {
        ...
        NSMutableAttributedString *mutableAttributedString = [[NSMutableAttributedString alloc] initWithString:textString];
        mutableAttributedString.yy_font = kFontSystem(14);// MHCommentTextFont;
        mutableAttributedString.yy_color = kColor4A;//MHGlobalBlackTextColor;
        mutableAttributedString.yy_lineSpacing = MHCommentContentLineSpacing;
        ...
        // 设置昵称颜色
        [mutableAttributedString yy_setColor:[UIColor hexStringToColor:@"#0C85EE" alpha:1.0f] range:NSMakeRange(0, self.fromUser.nickname.length)];
...
//        };
        ...
        [mutableAttributedString yy_setColor:[UIColor hexStringToColor:@"#0C85EE" alpha:1.0f] range:toUserRange];
        ...
        NSMutableAttributedString *mutableAttributedString = [[NSMutableAttributedString alloc] initWithString:textString];
        mutableAttributedString.yy_font = kFontSystem(13);
        mutableAttributedString.yy_color = kColor4A;//MHGlobalBlackTextColor;
        mutableAttributedString.yy_lineSpacing = MHCommentContentLineSpacing;
        
        NSRange fromUserRange = NSMakeRange(0, self.fromUser.nickname.length+1);
        // 设置昵称颜色
        [mutableAttributedString yy_setColor:[UIColor hexStringToColor:@"#0C85EE" alpha:1.0f] range:fromUserRange];
