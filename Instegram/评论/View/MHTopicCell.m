...
- (void)setTopicFrame:(MHTopicFrame *)topicFrame {
    ...
    [self.thumbBtn setTitle:@"回复" forState:UIControlStateNormal];
...
- (void)_setupSubViews {
    ...
    nicknameLable.text = @"";
    nicknameLable.font = kFontSystem(15);
    nicknameLable.textAlignment = NSTextAlignmentLeft;
    nicknameLable.textColor = kColor2E;//[UIColor lightGrayColor] ;
...
//    [thumbBtn setImage:kImageWithName(@"comment_zan_nor") forState:UIControlStateNormal];
//    [thumbBtn setImage:kImageWithName(@"comment_zan_high") forState:UIControlStateDisabled];
    [thumbBtn setTitleColor:kColor9F forState:UIControlStateNormal];
//    [thumbBtn setTitleColor:[UIColor redColor] forState:UIControlStateDisabled];
    [thumbBtn setTitle:@"回复" forState:UIControlStateNormal];
    [thumbBtn addTarget:self action:@selector(_thumbBtnDidClicked:) forControlEvents:UIControlEventTouchUpInside];
    thumbBtn.titleLabel.font = kFontSystem(14);
    ...
    [moreBtn setImage:kImageWithName(@"comment_more") forState:UIControlStateNormal];
    ...
    createTimeLabel.font = kFontSystem(11);
    createTimeLabel.textAlignment = NSTextAlignmentLeft;
    createTimeLabel.textColor = kColor9B;//[UIColor lightGrayColor] ;
    ...
    tableView.backgroundColor = [UIColor hexStringToColor:@"#F6F7FB" alpha:1.0f];
