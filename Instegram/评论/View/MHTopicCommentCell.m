...
- (void)_setup {
    // 设置颜色
    self.backgroundColor = [UIColor hexStringToColor:@"#F6F7FB" alpha:1.0f];//[UIColor whiteColor];
    self.contentView.backgroundColor = [UIColor hexStringToColor:@"#F6F7FB" alpha:1.0f];//[UIColor whiteColor];
}
